...
@InputType()
class AssignmentCreateNestedManyWithoutProjectsInput {
...
export { AssignmentCreateNestedManyWithoutProjectsInput as AssignmentCreateNestedManyWithoutProjectsInput };
